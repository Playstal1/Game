...
dependencies {
    ...
    //implementation("com.copyleaks.sdk:copyleaks-java-sdk:5.1.0")
...
application {
    mainClass = "main.java.com.turngame.Main"
}

tasks.jar {
    manifest {
        attributes(mapOf(
            "Main-Class" to "main.java.com.turngame.Main",
            "Implementation-Title" to "Game"
        ))
    }
